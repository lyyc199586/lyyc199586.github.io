...
**Neural operator-based damage sensing digital twin for piezocomposites with Parametrically Upscaled Coupled Constitutive Damage Model** (2026). _**Y. Liu**, S. Ghosh_. _Computer Methods in Applied Mechanics and Engineering_ 461, 119169.
[![DOI: https://doi.org/10.1016/j.cma.2026.119169](https://img.shields.io/static/v1?label=DOI&message=https%3A%2F%2Fdoi.org%2F10.1016%2Fj.cma.2026.119169&color=blue)](https://doi.org/https://doi.org/10.1016/j.cma.2026.119169)

<details>
<summary>Abstract</summary>
Early detection and tracking of damage for structural health monitoring (SHM) in challenging environments is critical for ensuring safety by preventing catastrophic failure and extending service life. This is particularly relevant as many techniques rely on sparse surface-mounted sensors, providing limited information on subsurface cracks that evolve to cause structural failure. Efficient in-situ reconstruction of temporally evolving deformation and damage fields in the bulk from sparse surface measurements can alleviate significant challenges faced by the SHM community. Coupling a machine learning-enabled multiscale multiphysics model, viz. the Parametrically Upscaled Coupled Constitutive Damage Model (PUCCDM) with Fourier neural operator (FNO) learning, this paper develops a Virtual Damage Sensing Digital Twin (VDS-DT) platform for piezoelectric composites. This platform interfaces with actual surface sensor measurements for efficient prediction of full-field temporally evolving deformation, electrical, and damage fields in the entire structure. A key feature of the framework is the incorporation of Representative Aggregated Microstructural Parameters (RAMPs), representing the characteristics of the underlying microstructure. These descriptors act as essential priors that regularize the inverse mapping and render the learned operator identifiable under sparse sensing. The mapping is learned using the FNO, trained on data generated by PUCCDM-based FE simulations, whose constitutive coefficients are explicitly represented as functions of the RAMPs. Furthermore, a genetic algorithm (GA) is employed to optimize sensor number and placement. Systematic studies demonstrate that the proposed VDS-DT platform achieves high-fidelity prediction of spatiotemporal damage evolution for both in-distribution and out-of-distribution testing cases, while revealing the complementary roles of sensor density and microstructure-informed priors (RAMPs). These results establish a unified paradigm for physics-informed, operator-based digital twins, providing a scalable pathway for real-time SHM with sparse sensing.
</details>
        

**RACCOON: A versatile framework for variational approaches to fracture with coupled field phenomena** (2026). _D. E. Torres, B. Zeng, A. Costa, **Y. Liu**, W. Jiang, J. E. Dolbow, T. Hu_. _Advances in Engineering Software_ 221, 104242.
[![DOI: 10.1016/j.advengsoft.2026.104242](https://img.shields.io/static/v1?label=DOI&message=10.1016%2Fj.advengsoft.2026.104242&color=blue)](https://doi.org/10.1016/j.advengsoft.2026.104242)
...
[![DOI: 10.48550/arXiv.2411.16393](https://img.shields.io/static/v1?label=DOI&message=10.48550%2FarXiv.2411.16393&color=blue)](https://doi.org/10.48550/arXiv.2411.16393)
...
[![URL: www.proquest.com](https://img.shields.io/static/v1?label=URL&message=www.proquest.com&color=blue)](https://www.proquest.com/dissertations-theses/computational-framework-simulating-crack/docview/3156269231/se-2?accountid=11752)
...
[![DOI: 10.1016/j.ijsolstr.2023.112626](https://img.shields.io/static/v1?label=DOI&message=10.1016%2Fj.ijsolstr.2023.112626&color=blue)](https://doi.org/10.1016/j.ijsolstr.2023.112626)
...
[![DOI: 10.1016/j.jmps.2023.105473](https://img.shields.io/static/v1?label=DOI&message=10.1016%2Fj.jmps.2023.105473&color=blue)](https://doi.org/10.1016/j.jmps.2023.105473)
...
[![DOI: 10.1016/j.ultsonch.2023.106649](https://img.shields.io/static/v1?label=DOI&message=10.1016%2Fj.ultsonch.2023.106649&color=blue)](https://doi.org/10.1016/j.ultsonch.2023.106649)
...
[![DOI: 10.1016/j.ijheatmasstransfer.2022.123843](https://img.shields.io/static/v1?label=DOI&message=10.1016%2Fj.ijheatmasstransfer.2022.123843&color=blue)](https://doi.org/10.1016/j.ijheatmasstransfer.2022.123843)
...
[![DOI: 10.1007/s42452-020-03468-6](https://img.shields.io/static/v1?label=DOI&message=10.1007%2Fs42452-020-03468-6&color=blue)](https://doi.org/10.1007/s42452-020-03468-6)
...
## Presentations
**Virtual Damage Sensing Digital Twin for Piezocomposites Integrating Neural Operator with Parametrically Upscaled Constitutive Damage Model** (2026). _**Y. Liu**, S. Ghosh_. _[20th U.S. National Congress on Theoretical and Applied Mechanics (USNCTAM26)](https://www.usnctam26.org/home)_ (Oral presentation), Pasadena, California.

**Damage Sensing Digital Twin for Piezocomposites Integrating Neural Operator with Parametrically Upscaled Constitutive Damage Model** (2026). _**Y. Liu**_. _USACM Student Chapter Seminar Series_ (Seminar presentation), Online.

**Virtual Damage Sensing Digital Twin for Piezocomposites Integrating Neural Operator with Parametrically Upscaled Constitutive Damage Model** (2026). _**Y. Liu**, S. Ghosh_. _[Enabling Multifunctionality through AI Informed Material Discovery and System Design (GRC 2026)](https://www.grc.org/multifunctional-materials-and-structures-conference/2026/)_ (Poster presentation), Ventura, California.

**Virtual Damage Sensing Digital Twin for Piezocomposites Integrating Neural Operator with Parametrically Upscaled Constitutive Damage Model** (2026). _**Y. Liu**, S. Ghosh_. _[HEMI Day 2026](https://hemi.jhu.edu/event/hemi-day-2026/)_ (Podium presentation), Baltimore, Maryland.
...
**A model-based simulation framework for coupled acoustics, elastodynamics, and damage with application to nano-pulse lithotripsy** (2023). _**Y. Liu**, P. Zhong, O. Lopez-Pamies, J. E. Dolbow_. _the 17th United States National Congress on Computational Mechanics (USNCCM17)_, Albuquerque, New Mexico.
...
**A homogenization-based phase field approach to fracture** (2019). _**Y. Liu**, C. Cheng, Y. Shen_. _the 15th United States National Congress on Computational Mechanics (USNCCM15)_, Austin, Texas.
