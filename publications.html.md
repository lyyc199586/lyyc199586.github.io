...
**Neural operator-based damage sensing digital twin for piezocomposites with Parametrically Upscaled Coupled Constitutive Damage Model** (2026). _Y. Liu, S. Ghosh_. _Computer Methods in Applied Mechanics and Engineering_ 461, 119169.
...
## Presentations
**Virtual Damage Sensing Digital Twin for Piezocomposites Integrating Neural Operator with Parametrically Upscaled Constitutive Damage Model** (2026). _Y. Liu, S. Ghosh_. _[20th U.S. National Congress on Theoretical and Applied Mechanics (USNCTAM26)](https://www.usnctam26.org/home)_ (Oral presentation), Pasadena, California.

**Damage Sensing Digital Twin for Piezocomposites Integrating Neural Operator with Parametrically Upscaled Constitutive Damage Model** (2026). _Y. Liu_. _USACM Student Chapter Seminar Series_ (Seminar presentation), Online.

**Virtual Damage Sensing Digital Twin for Piezocomposites Integrating Neural Operator with Parametrically Upscaled Constitutive Damage Model** (2026). _Y. Liu, S. Ghosh_. _[Enabling Multifunctionality through AI Informed Material Discovery and System Design (GRC 2026)](https://www.grc.org/multifunctional-materials-and-structures-conference/2026/)_ (Poster presentation), Ventura, California.

**Virtual Damage Sensing Digital Twin for Piezocomposites Integrating Neural Operator with Parametrically Upscaled Constitutive Damage Model** (2026). _Y. Liu, S. Ghosh_. _[HEMI Day 2026](https://hemi.jhu.edu/event/hemi-day-2026/)_ (Podium presentation), Baltimore, Maryland.

**A phase-field approach for the nucleation and propagation of dynamic cracks** (2024). _Y. Liu, O. Lopez-Pamies, J. E. Dolbow_. _The 16th World Congress on Computational Mechanics (WCCM16)_, Vancouver, Canada.
