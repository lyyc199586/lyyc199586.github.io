...
Note: I am using [Colab](https://colab.research.google.com) to run FEniCS codes, colab is an online coding platform supproted by Google. It is the most convenient way to play with FEniCS and share your notebook with other users.
